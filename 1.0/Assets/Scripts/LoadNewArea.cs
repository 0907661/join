...
public class LoadNewArea : MonoBehaviour {
	...
	void Start () {
        player1 = transform.FindChild("Red Plate");
        player2 = transform.FindChild("Yellow Plate");
        player3 = transform.FindChild("Green Plate");
        player4 = transform.FindChild("Blue Plate");
